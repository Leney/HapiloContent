package com.zhongke.content.oss;
...
//        OSSCredentialProvider credentialProvider = new OSSStsTokenCredentialProvider(accessKeyId, accessKeySecret, securityToken);
        ...
        OSSLog.enableLog();
        oss = new OSSClient(HPApplication.getInstance(), endpoint, credentialProvider);
    }
...
//                LogUtil.e("PutObject", "currentSize: " + currentSize + " totalSize: " + totalSize);
    ...
    public void uploadImage(String bucketName, final String objectKey, String uploadFilePath, final CallBackListener<String> callBack) {
