...
public class ActivityListAdapter extends RecyclerView.Adapter<ActivityListAdapter.MyViewHolder> {
    private List<ActivityListBean2.RecordsBean> list;
    private Context context;
    private OnItemClickListener onItemClickListener;

    public ActivityListAdapter(List<ActivityListBean2.RecordsBean> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ActivityListBean2.RecordsBean bean = list.get(position);
