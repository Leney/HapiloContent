...
public class NotStartExerciseAdapter extends BaseAdapter {
    private List<ExerciseBean> list;
    private Context context;

    public NotStartExerciseAdapter(List<ExerciseBean> list, Context context) {
        this.list = list;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (null == view) {
            ...
            view = LayoutInflater.from(context).inflate(R.layout.item_not_staet_exercise, null);
        ...
        holder.tvStartTime.setText(eb.getStartTime());
