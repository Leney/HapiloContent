...
public class OnGoingExerciseAdapter extends BaseAdapter {
    private List<ExerciseBean> list;
    private Context context;

    public OnGoingExerciseAdapter(List<ExerciseBean> list, Context context) {
        this.list = list;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (null == view) {
            ...
            view = LayoutInflater.from(context).inflate(R.layout.item_going_exercise, null);
