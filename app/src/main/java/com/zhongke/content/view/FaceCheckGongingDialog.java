...
public class FaceCheckGongingDialog extends BaseDialog{
    public FaceCheckGongingDialog(@NonNull Context context, View.OnClickListener onClickListener) {
    ...
    protected View getRootView() {
        return View.inflate(context, R.layout.dialog_face_check_gonging,null) ;
    }
