...
public class AnswerFailureDialog extends BaseDialog {
    ...
    protected void initView(View rootView) {
        ...
        this.bg1_iv = rootView.findViewById(R.id.answer_failure_bg1_iv);
        this.bg2_iv = rootView.findViewById(R.id.answer_failure_bg2_iv);
        this.text_tip_iv = rootView.findViewById(R.id.answer_failure_text_tip_iv);
        this.reduce_10_iv = rootView.findViewById(R.id.answer_failure_reduce_10_iv);
        hideAllView();
        animatorChildStart();
    }
