...
public class AnswerRewardDialog extends BaseDialog implements Dialog.OnDismissListener {
    ...
    protected void initView(View rootView) {
        ...
        bg1_iv = rootView.findViewById(R.id.answer_reward_rorate_iv);
        bg2_iv = rootView.findViewById(R.id.answer_reward_bg2_iv);
        bg3_iv = rootView.findViewById(R.id.answer_reward_bg3_iv);
        round_iv = rootView.findViewById(R.id.answer_reward_round_iv);
        score_iv = rootView.findViewById(R.id.answer_reward_score_iv);
        score_true_iv = rootView.findViewById(R.id.answer_reward_true_tv);
        score_tv = rootView.findViewById(R.id.answer_reward_score_tv);
        star_iv = rootView.findViewById(R.id.answer_reward_star_iv);
        star_iv2 = rootView.findViewById(R.id.answer_reward_star_iv_2);
        star_iv3 = rootView.findViewById(R.id.answer_reward_star_iv_3);
        star_iv4 = rootView.findViewById(R.id.answer_reward_star_iv_4);
        star_iv5 = rootView.findViewById(R.id.answer_reward_star_iv_5);
        star_iv6 = rootView.findViewById(R.id.answer_reward_star_iv_6);
        hideAllView();
        setRoundAnimator();
    }
