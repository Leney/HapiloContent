...
public class AudioPlayManager implements SensorEventListener {
    ...
    private IAudioPlayUrlListener _playListenerUrl;
...
//                        this._mediaPlayer.setDataSource(this.context, this._playingUri);
                        this._mediaPlayer.setDataSource(this._playingUrl);
...
//            this._mediaPlayer.setDataSource(this.context, this._playingUri);
    ...
    public void startPlay(Context context, String audioUrl, IAudioPlayUrlListener playListenerUrl) {
        if (context != null && audioUrl != null) {
            this.context = context;
            if (this._playListenerUrl != null && this._playingUrl != null) {
                this._playListenerUrl.onStop(this._playingUrl);
            }
            ...
            try {
                ...
                this.muteAudioFocus(this._audioManager, true);
                this._playListenerUrl = playListenerUrl;
                this._playingUrl = audioUrl;
                this._mediaPlayer = new MediaPlayer();
                this._mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    public void onCompletion(MediaPlayer mp) {
                        if (AudioPlayManager.this._playListenerUrl != null) {
                            AudioPlayManager.this._playListenerUrl.onComplete(AudioPlayManager.this._playingUrl);
                            AudioPlayManager.this._playListenerUrl = null;
                            AudioPlayManager.this.context = null;
                        }
                ...
                this._mediaPlayer.setDataSource(audioUrl);
                this._mediaPlayer.setAudioStreamType(3);
                this._mediaPlayer.prepare();
                this._mediaPlayer.start();
                if (this._playListenerUrl != null) {
                    this._playListenerUrl.onStart(this._playingUrl);
                }
            } catch (Exception var5) {
                var5.printStackTrace();
                if (this._playListenerUrl != null) {
                    this._playListenerUrl.onStop(audioUrl);
                    this._playListenerUrl = null;
                }
